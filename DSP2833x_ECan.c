...
/* set data bytes order */
    //ECanaShadow.CANMC.all = ECanaRegs.CANMC.all;
	//ECanaShadow.CANMC.bit.DBO = 1 ;            // Set DBO = 1:data is tx or rx LSB byte first
    //ECanaRegs.CANMC.all = ECanaShadow.CANMC.all;
...
/* Configure bit timing parameters for eCANA*/
    ...
    ECanaShadow.CANBTC.all = 0;
		...
		/* The following block for all 150 MHz SYSCLKOUT - default. Bit rate = sysclk/(2*(BRP+1)((T2+1)+(T1+1)+1)=125kbps */
